...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        Klass classBp2 = new Klass("Budapest 2016-2", CCLocation.Location.BUDAPEST);
        Address address = new Address("Hungary", "1234", "Budapest", "Macskakő út 5.");
        List<String> phoneNumbers1 = Arrays.asList ("06303405701", "06207438701");
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1, address, phoneNumbers1);
        ...
        List<String> phoneNumbers2 = Arrays.asList ("06303405702", "06207438702");
